...
if __name__ == '__main__':
    ...
    pidTrainingData = np.loadtxt('pidTrainingDataMultiple.dat')
    ...
    pidTestingData = np.loadtxt('pidTestingDataMultiple.dat')
    ...
    testString = str(trainingFunction).zfill(2)
    ...
    np.savetxt('./output/zulu_%s_%s_%s_%s_error.dat' % 
               (identifier, testString, nodesString, layersString),
               outputError)